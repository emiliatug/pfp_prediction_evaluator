...
input10="./Log_files/NN, global2_epoch_opt_no_early_stop_weighted_loss1,./Regression/Results/IntermediateData/NN/manual_tuning/epoch_opt_no_early_stop, weighted_loss,epoch_opt_no_early_stop,0,1,2,3,4"
## 2nd Run variables
# Train Data: Folds structured as (fold0A, fold0B, fold1A, fold1B, ..., fold5A, fold5B)
