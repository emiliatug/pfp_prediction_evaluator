...
# # # # ################################################3###This part is for PART2_4 and PART5 mb_SGD ######################################################
## Common Variables
...
input5='5,101'
input6="LogScaler,StandardScaler"
...
input10="./Log_files/Linear, global2_linear_mb_SGD_log_and_StandardS,./Regression/Results/IntermediateData/Linear_Regression/mb_SGD/log_and_StandardS/Part2_4, Grid-Search,./Regression/Results/Final_Results/Linear_Regression/mb_SGD/log_and_StandardS/, NoGrid-Search,Part4_of_5,Part5_of_5" 
## 2nd Run variables
# Train Data: Folds structured as (fold0A, fold0B, fold1A, fold1B, ..., fold5A, fold5B)
