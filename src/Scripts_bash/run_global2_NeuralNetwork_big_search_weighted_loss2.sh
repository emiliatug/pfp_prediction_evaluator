...
input10="./Log_files/NN, global2_big_search_weighted_loss2,./Regression/Results/Final_Results/NN/big_search, weighted_loss, big_search,./ResultsIntermediateData/NN/manual_tuning/big_search/models"
## 2nd Run variables
# Train Data: Folds structured as (fold0A, fold0B, fold1A, fold1B, ..., fold5A, fold5B)
