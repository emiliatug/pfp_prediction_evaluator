...
input10="./Log_files/Linear, global2_linear_mb_SGD_logS,./Regression/Results/IntermediateData/Linear_Regression/mb_SGD/logS/Part2_4, Grid-Search,./Regression/Results/Final_Results/Linear_Regression/mb_SGD/logS/, NoGrid-Search,Part4_of_5,Part5_of_5" 
## 2nd Run variables
# Train Data: Folds structured as (fold0A, fold0B, fold1A, fold1B, ..., fold5A, fold5B)
