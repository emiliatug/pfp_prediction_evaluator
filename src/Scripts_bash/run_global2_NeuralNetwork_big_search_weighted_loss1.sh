...
input10="./Log_files/NN, global2_big_search_weighted_loss1,./Regression/Results/IntermediateData/NN/manual_tuning/big_search, weighted_loss, big_search" 
## 2nd Run variables
# Train Data: Folds structured as (fold0A, fold0B, fold1A, fold1B, ..., fold5A, fold5B)
...
input14="Adam,Adagrad,RMSprop" #Adam adapts well to the changing learning rate; Adagrad good for sparse; aggressive learn rate decay if network is shallow
input15="1,5,10,15,20,25"
#below was for the big search
