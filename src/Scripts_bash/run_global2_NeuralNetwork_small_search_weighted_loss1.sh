...
input10="./Log_files/NN, global2_small_search_weighted_loss1,./Regression/Results/IntermediateData/NN/manual_tuning/small_search_weighted, weighted_loss, small_search" 
## 2nd Run variables
# Train Data: Folds structured as (fold0A, fold0B, fold1A, fold1B, ..., fold5A, fold5B)
