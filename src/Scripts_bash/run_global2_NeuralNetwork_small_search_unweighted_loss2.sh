...
input10="./Log_files/NN, global2_small_search_unweighted_loss2,./Regression/Results/Final_Results/NN/small_search_unweighted, unweighted_loss, small_search,./ResultsIntermediateData/NN/manual_tuning/small_search_unweighted/models"
## 2nd Run variables
# Train Data: Folds structured as (fold0A, fold0B, fold1A, fold1B, ..., fold5A, fold5B)
